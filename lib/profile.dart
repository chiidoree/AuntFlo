          ...
          child: (userId.isNotEmpty)
              ? FutureBuilder(
                  future: FirebaseDatabaseService()
                      .getUserDetailsUsingUid(uId: userId),
  ...
  Widget build(BuildContext context){
    return Container(
      ...
      child: Column(
        ...
        children: [
          userModel !=null? Text('Name: ${userModel!.fullName}',style: TextStyle(fontSize: 20),): Text('Name: -'),
          SizedBox(height: 10),
          userModel !=null? Text('Email: ${userModel!.emailAddress}', style: TextStyle(fontSize: 20),): Text('Emaail: -'),
          SizedBox(height: 25),
